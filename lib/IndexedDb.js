...
class Collection {
    ...
    _findFetch(selector, options, success, error) {
        ...
        return this.store.query(function (matches) {
            ...
            if (success != null) {
                return success((0, utils_1.processFind)(lodash_1.default.pluck(matches, "doc"), selector, options));
            }
    ...
    pendingRemoves(success, error) {
        return this.store.query(function (matches) {
            if (success != null) {
                return success(lodash_1.default.pluck(lodash_1.default.pluck(matches, "doc"), "_id"));
            }
