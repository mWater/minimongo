...
class Collection {
    ...
    upsert(docs, bases, success, error) {
        ...
        if (lodash_1.default.isArray(docs)) {
            if (success) {
                return success(this._applySafety(lodash_1.default.pluck(items, "doc")));
            }
        }
        else {
            if (success) {
                return success(this._applySafety(lodash_1.default.pluck(items, "doc")[0]));
            }
        }
    }
    ...
    uncache(selector, success, error) {
        ...
        this.items = lodash_1.default.object(lodash_1.default.pluck(items, "_id"), items);
        if (success != null) {
            return success();
        }
    }
    uncacheList(ids, success, error) {
        const idIndex = lodash_1.default.indexBy(ids);
        const items = lodash_1.default.filter(lodash_1.default.values(this.items), (item) => {
