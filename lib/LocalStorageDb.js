...
class Collection {
    ...
    loadStorage() {
        ...
        const removeItems = window.localStorage[this.namespace + "removes"]
            ...
            : [];
        return (this.removes = lodash_1.default.object(lodash_1.default.pluck(removeItems, "_id"), removeItems));
    }
    ...
    _deleteUpsert(id) {
        ...
        if (this.namespace) {
            return (window.localStorage[this.namespace + "upserts"] = JSON.stringify(lodash_1.default.keys(this.upserts)));
        }
    }
    _putRemove(doc) {
        this.removes[doc._id] = doc;
        if (this.namespace) {
            return (window.localStorage[this.namespace + "removes"] = JSON.stringify(lodash_1.default.values(this.removes)));
        }
    }
    _deleteRemove(id) {
    ...
    cache(docs, selector, options, success, error) {
        ...
        const docsMap = lodash_1.default.object(lodash_1.default.pluck(docs, "_id"), docs);
        if (options.sort) {
    ...
    pendingRemoves(success) {
        return success(lodash_1.default.pluck(this.removes, "_id"));
    }
