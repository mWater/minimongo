...
var builtinConverters = [
    ...
    },
    {
        ...
        matchObject: function (obj) {
            ...
            return lodash_1.default.any(builtinConverters, function (converter) {
...
var fromJSONValueHelper = function (value) {
    if (typeof value === "object" && value !== null) {
        if (lodash_1.default.size(value) <= 2 &&
            lodash_1.default.all(value, function (v, k) {
...
EJSON.equals = function (a, b, options) {
    ...
    if (keyOrderSensitive) {
        ...
        i = 0;
        ret = lodash_1.default.all(a, function (val, x) {
            if (i >= bKeys.length) {
                return false;
            }
            if (x !== bKeys[i]) {
        ...
        i = 0;
        ret = lodash_1.default.all(a, function (val, key) {
