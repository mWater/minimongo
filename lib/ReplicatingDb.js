...
class Collection {
    ...
    upsert(docs, bases, success, error) {
        ...
        // Upsert does to both
        return this.masterCol.upsert(lodash_1.default.pluck(items, "doc"), lodash_1.default.pluck(items, "base"), () => {
            return this.replicaCol.upsert(lodash_1.default.pluck(items, "doc"), lodash_1.default.pluck(items, "base"), (results) => {
                return success(docs);
            }, error);
        }, error);
    }
    ...
    cache(docs, selector, options, success, error) {
        ...
        // Index docs
        let sort;
        const docsMap = lodash_1.default.indexBy(docs, "_id");
        // Compile sort
        if (options.sort) {
        ...
        return this.masterCol.find(selector, options).fetch((results) => {
            let result;
            const resultsMap = lodash_1.default.indexBy(results, "_id");
