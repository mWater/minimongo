...
describe("quickfind", function () {
  before(function (this: any, this: any, this: any, this: any, this: any) {
  ...
  it("encodes as expected", function (this: any, this: any, this: any) {
  ...
  it("only includes changes", function (this: any, this: any, this: any, this: any, this: any, this: any) {
    const request = quickfind.encodeRequest([this.row3, this.row2, this.row1])
  ...
  it("starts with blank", function (this: any, this: any, this: any, this: any) {
    return this.completeTest([], [this.row1, this.row2, this.row3])
  })

  it("goes to blank", function (this: any, this: any, this: any, this: any) {
    return this.completeTest([this.row1, this.row2, this.row3], [])
  })

  it("replaces", function (this: any, this: any, this: any, this: any, this: any, this: any, this: any) {
    return this.completeTest([this.row1, this.row2, this.row3], [this.row1, this.row2a, this.row3])
  })

  return it("sorts", function (this: any, this: any, this: any, this: any, this: any, this: any, this: any) {
